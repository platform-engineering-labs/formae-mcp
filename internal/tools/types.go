...
type ApplyFormaInput struct {
	Context    *SourceContext   `json:"context,omitempty" jsonschema:"Per-call source context selected with get_codebase_context. A maintained file must be inside its binding and every evaluated stack within scope."`
